...
(function ($) {
  ...
  function block_calender_slide() {
    jQuery(".book-appointment-btn, .books-appointment-close").on(
      "click",
      function () {
  ...
  function edit_appointments_slide() {
    jQuery(".aon-book-appoint-block, .edit-appointments-close").on(
      "click",
      function () {
  ...
  function edit_availibility_slide() {
    jQuery(
      ".aon-availibility-edit, .aon-avai-edit-btn, .cs-availibility-close"
    ).on("click", function () {
  ...
  function image_BeforeAfter() {
    jQuery("#sidebarCollapse").on("click", function () {
      jQuery("#header-admin, #sidebar-admin-wraper, #content").toggleClass(
        "active"
      );
    });
  }
